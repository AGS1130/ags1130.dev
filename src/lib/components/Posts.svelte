  ...
  <article>
    ...
    <div>
      <p>
        ...
        Mollitia vel rerum quasi omnis, illo earum repudiandae, excepturi ab esse, nesciunt minus praesentium vero!
      </p>
    </div>
    <p>
      <a href="https://google.com" target="_blank"> Keep reading </a>
    </p>
  </article>
{/each}
